                    ...
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            <div class="profile-image">
                                <img class="img-xs rounded-circle" src="../pro_img/{{Session::get('adminPhoto')}}" alt="profile image">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><img src=" ..\pro_img\{{$p->productImage}}" style="height: 100px; width: 100px;"></td>
                                        <td>{{$p->catID}}</td>
                                        <td>
                                            <a href="{{ url('product-edit/'.$p->productID)}}" class="btn btn-danger">Edit</a> |
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ url('product-delete/'.$p->productID)}}" class="btn btn-danger">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
