                                    ...
                                    <div class="proLoop">
                                        <div class="pro_content">
                                            <div class="productImg">
                                                <a href="#" title="{{$product->productName}}" class="productImgLink">
                                                    <picture>
                                                        ...
                                                        <img data-src="//product.hstatic.net/200000680123/product/pc_fire_1650_ef13964a0d60485d8bc2ee83a35466c5_grande.jpg" src="//product.hstatic.net/200000680123/product/pc_fire_1650_ef13964a0d60485d8bc2ee83a35466c5_grande.jpg" class="img-fluid lazyloaded" alt=" {{$product->productName}} ">
                                                    </picture>
                                                    <picture>
                                                        <source srcset="//product.hstatic.net/200000680123/product/pc_fire_1650_ef13964a0d60485d8bc2ee83a35466c5_medium.jpg" data-srcset="//product.hstatic.net/200000680123/product/pc_fire_1650_ef13964a0d60485d8bc2ee83a35466c5_medium.jpg" media="(max-width: 767px)">
                                                        <img data-src="//product.hstatic.net/200000680123/product/pc_fire_1650_ef13964a0d60485d8bc2ee83a35466c5_large.jpg" src="//product.hstatic.net/200000680123/product/pc_fire_1650_ef13964a0d60485d8bc2ee83a35466c5_large.jpg" class="img-fluid ls-is-cached lazyloaded" alt=" {{$product->productName}} ">
                                                    </picture>
                                                </a>
                                            </div>
                                            <h3 class="productName">
                                                <a href="#" title="{{$product->productName}}">{{$product->productName}}</a>
                                            </h3>
                                            ...
                                            <div class="p-btn-group">
                                                <a href="{{route('shop-cart-add')}}" class="AddCartLoop" data-id="{{$product->id}}" data-href="{{ route('shop-list-cart') }}">
